                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('edit.ranking.new.store') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="rank_name" class="form-control" value="{{ old('rank_name', $ranking->rank_name) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" dir="ltr" name="rank_name_en" class="form-control" value="{{ old('rank_name_en', $ranking->rank_name_en) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea name="rank_description" class="form-control">{{ old('rank_description', $ranking->rank_description) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea dir="ltr" name="rank_description_en" class="form-control">{{ old('rank_description_en', $ranking->rank_description_en) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="rank_order" class="form-control" value="{{ old('rank_order', $ranking->rank_order) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_last" value="1" id="flexSwitchCheckDefault" {{ $ranking->is_last == 1 ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_free" value="1" id="isFreeSwitch" {{ $ranking->is_free == 1 ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="rank_reward_coin_id" class="form-select mb-3" aria-label="Default select example">
                                            ...
                                            <option value="{{ $coin->id }}" {{ $ranking->rank_reward_coin_id == $coin->id ? 'selected' : '' }}>{{ $coin->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="rank_reward_amount" class="form-control" value="{{ old('rank_reward_amount', $ranking->rank_reward_amount) }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="levels_count" id="levels_count" class="form-control" value="{{ old('levels_count', $ranking->levels_count) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="wins_to_next_level" id="wins_to_next_level" class="form-control" value="{{ old('wins_to_next_level', $ranking->wins_to_next_level) }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" id="total_wins_preview" class="form-control bg-light" value="{{ old('levels_count', $ranking->levels_count) * old('wins_to_next_level', $ranking->wins_to_next_level) }}" readonly />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="level_reward_coin_id" class="form-select mb-3" aria-label="Default select example">
                                            <option value="">اختر العملة</option>
                                            @foreach($coins as $coin)
                                            <option value="{{ $coin->id }}" {{ $ranking->level_reward_coin_id == $coin->id ? 'selected' : '' }}>{{ $coin->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
