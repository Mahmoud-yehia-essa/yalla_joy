...
<div class="container">
    <div class="main-body">
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('edit.admin.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
		...
		<select  name="roles" class="form-select mb-3" aria-label="Default select example">
						<option selected="" value="non">الرجاء اختيار دور</option>
             ...
             @error('roles') <span class="text-danger">{{ $message }}</span> @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ (!empty($user->photo) && $user->photo != 'non' ) ? url('upload/admin_images/'.$user->photo):url('upload/no_image.jpg') }}" alt="Admin" width="110">
