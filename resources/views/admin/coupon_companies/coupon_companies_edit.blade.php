...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">تعديل كوبون الشركة</div>
        <div class="ps-3">
        ...
        <div class="main-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{ route('update.coupon_companies') }}">
                                @csrf
                                <input type="hidden" name="id" value="{{ $couponCompany->id }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="coupon_name" class="form-control" value="{{ $couponCompany->coupon_name }}" />
                                        @error('coupon_name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="coupon_name_en" class="form-control" value="{{ $couponCompany->coupon_name_en }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="coupon_code" class="form-control" value="{{ $couponCompany->coupon_code }}" readonly />
                                        @error('coupon_code')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <select name="sponsor_id" class="form-select">
                                            ...
                                            <option value="{{ $sponsor->id }}" {{ $couponCompany->sponsor_id == $sponsor->id ? 'selected' : '' }}>{{ $sponsor->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('sponsor_id')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <textarea name="coupon_description" class="form-control" rows="3">{{ $couponCompany->coupon_description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <textarea name="coupon_description_en" class="form-control" rows="3">{{ $couponCompany->coupon_description_en }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <select name="game_coin_id" class="form-select">
                                            ...
                                            <option value="{{ $coin->id }}" {{ $couponCompany->game_coin_id == $coin->id ? 'selected' : '' }}>{{ $coin->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="number" name="game_coins_count" class="form-control" value="{{ $couponCompany->game_coins_count }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_scratch_coupon" id="is_scratch_coupon" value="1" {{ $couponCompany->is_scratch_coupon ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_special_coupon" id="is_special_coupon" value="1" {{ old('is_special_coupon', $couponCompany->is_special_coupon) ? 'checked' : '' }}>
...
@endphp
                                ...
                                <div class="row mb-3" id="special_coupon_message_container" style="display: none;">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        ...
                                        <textarea id="special_coupon_message" name="special_coupon_message" class="form-control" rows="10">{{ old('special_coupon_message', $couponCompany->special_coupon_message ?: $defaultEmailTemplate) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="تحديث الكوبون" />
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    $(document).ready(function (){
        ...
        $('#myForm').validate({
            ...
            messages :{
                ...
                coupon_code: { required : 'الرجاء ادخال كود الكوبون' },
