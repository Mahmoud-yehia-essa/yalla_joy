     ...
     <input name="answer_title_two" type="text" class="form-control"  value="{{ old('answer_title_two', $question->answerQuestionOnlines[1]->answer_title) }}"  />
        ...
        <br>
            @if ($question->answerQuestionOnlines[1]->answer_type == 'image')
                            <img id="showAnswerImage" src="{{ url('upload/answers/online/images/' . $question->answerQuestionOnlines[1]->answer_image) }}" alt="Admin" width="110" class="mt-2">
                        @elseif ($question->answerQuestionOnlines[1]->answer_type == 'video')

                            <video width="400px" controls><source src="{{ url('upload/answers/online/videos/' . $question->answerQuestionOnlines[1]->answer_video) }}" type="video/mp4"></video>
