...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">تعديل كوبون الألعاب</div>
    </div>
    <!--end breadcrumb-->
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update.game.coupon') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="code" class="form-control" placeholder="مثل: GAME50" value="{{ $coupon->code }}" required />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="type" id="coupon_type" class="form-select" required>
                                            ...
                                            <option value="percentage" {{ $coupon->type == 'percentage' ? 'selected' : '' }}>نسبة مئوية من السعر (Percentage Discount)</option>
                                            <option value="free_games" {{ $coupon->type == 'free_games' ? 'selected' : '' }}>ألعاب مجانية مباشرة (Free Games Count)</option>
                                            <option value="package_bonus" {{ $coupon->type == 'package_bonus' ? 'selected' : '' }}>ألعاب إضافية مع باقة شراء (Package Bonus)</option>
                                        </select>
                                ...
                                <div class="row mb-3" id="discount_percentage_div" style="display: none;">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" step="0.01" name="discount_percentage" class="form-control" value="{{ $coupon->discount_percentage }}" min="0" max="100" />
                                ...
                                <div class="row mb-3" id="free_games_count_div" style="display: none;">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="free_games_count" class="form-control" value="{{ $coupon->free_games_count }}" min="0" />
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="game_purchases_id" class="form-select">
                                            ...
                                            @foreach($purchases as $p)
                                                <option value="{{ $p->id }}" {{ $coupon->game_purchases_id == $p->id ? 'selected' : '' }}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="usage_limit" class="form-control" placeholder="اتركه فارغًا للاستخدام اللانهائي" value="{{ $coupon->usage_limit }}" min="1" />
