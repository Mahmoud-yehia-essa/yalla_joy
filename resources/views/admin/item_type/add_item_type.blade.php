...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">إضافة نوع عنصر لعبة</div>
</div>
<hr/>
...
<div class="card">
    <div class="card-body p-4">
        ...
        <form method="post" action="{{ route('store.item.type') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="ادخل اسم النوع">
                    @error('name')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="name_en" class="form-control" placeholder="Enter item type name in English">
                    @error('name_en')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="3" placeholder="ادخل الوصف"></textarea>
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
