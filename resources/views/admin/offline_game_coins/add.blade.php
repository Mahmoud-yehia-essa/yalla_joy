...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">إضافة عملات فائز في لعبة الجلسة</div>
    </div>
    <!--end breadcrumb-->
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('store.offline.game.coins') }}">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="إضافة عملات فائز في لعبة الجلسة" />
                                    </div>
                                </div>
                            </form>
                        </div>
