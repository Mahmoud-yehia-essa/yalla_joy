...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">اضافة مكافأت مع الرعاة</div>
					<div class="ps-3">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('store.rewards.sponsors') }}" enctype="multipart/form-data"  >
			@csrf
      <!-- Question  category-->
                                <div class="row mb-3">
                                    <div class="col-sm-3">
          ...
          <div class="row mb-3">
              ...
              <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="number" name="number_of_points" class="form-control"   />
            ...
            {{-- <div class="row mb-3">
              ...
              <div class="row mb-3">
                                 ...
                                 <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" dir="ltr" name="des_en" class="form-control" value="{{ old('des_en') }}" />
                                        @error('des_en')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
