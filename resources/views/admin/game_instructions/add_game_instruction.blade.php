...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">إضافة قسم / وصف جديد</div>
        <div class="ps-3">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form method="post" action="{{ route('add.game.instruction.store') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="section_type" class="form-select">
                                            <option value="section" {{ old('section_type', 'section') == 'section' ? 'selected' : '' }}>قسم تفصيلي (بطاقة محتوى بأيقونة وبنود)</option>
                                            <option value="intro" {{ old('section_type') == 'intro' ? 'selected' : '' }}>مقدمة رئيسية (البطاقة التمهيدية العلوية للعبة)</option>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="مثال: آلية اللعب ونظام الأدوار" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" dir="ltr" name="title_en" class="form-control" value="{{ old('title_en') }}" placeholder="e.g. Gameplay & Turns System" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="icon" class="form-select">
                                            <option value="settings" {{ old('icon') == 'settings' ? 'selected' : '' }}>⚙️ Settings (إعدادات / آلية اللعب)</option>
                                            <option value="timer" {{ old('icon') == 'timer' ? 'selected' : '' }}>⏱️ Timer (الوقت والمستويات)</option>
                                            <option value="analytics" {{ old('icon') == 'analytics' ? 'selected' : '' }}>📊 Analytics / Scoring (احتساب النقاط والنتائج)</option>
                                            <option value="sports_esports" {{ old('icon') == 'sports_esports' ? 'selected' : '' }}>🎮 Gamepad (طريقة وأسلوب اللعب)</option>
                                            <option value="people" {{ old('icon') == 'people' ? 'selected' : '' }}>👥 People (اللاعبين / طرق الدخول والمنافسة)</option>
                                            <option value="play_circle" {{ old('icon') == 'play_circle' ? 'selected' : '' }}>▶️ Play Circle (بداية وتحديد الفريق)</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="intro" rows="2" class="form-control" placeholder="مقدمة أو عبارة تمهيدية تظهر أعلى النقاط في البطاقة">{{ old('intro') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="content" rows="6" class="form-control" placeholder="اكتب كل نقطة أو بند في سطر مستقل لكي تظهر كنقاط مرتبة في التطبيق">{{ old('content') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea dir="ltr" name="content_en" rows="4" class="form-control" placeholder="English content (one bullet point per line)">{{ old('content_en') }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="order_by" class="form-control" value="{{ old('order_by', 1) }}" min="1" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="submit" class="btn btn-primary px-4" value="حفظ وإضافة القسم" />
