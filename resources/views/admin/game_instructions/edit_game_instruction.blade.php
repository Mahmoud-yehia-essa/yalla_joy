                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="game_target" class="form-select">
                                            ...
                                            <option value="kids_entertainment" {{ old('game_target', $instruction->game_target) == 'kids_entertainment' ? 'selected' : '' }}>ترفيهي أطفال (ألعاب ترفيهية للأطفال)</option>
                                            <option value="kids_education" {{ old('game_target', $instruction->game_target) == 'kids_education' ? 'selected' : '' }}>تعليم و تسلية (ألعاب تعليمية وترفيهية للأطفال)</option>
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="icon" class="form-select">
                                            ...
                                            <option value="sentiment_very_satisfied" {{ old('icon', $instruction->icon) == 'sentiment_very_satisfied' ? 'selected' : '' }}>😄 Smile / Fun (ترفيه ومرح للأطفال)</option>
                                            <option value="school" {{ old('icon', $instruction->icon) == 'school' ? 'selected' : '' }}>🎓 School (تعليم ودراسة)</option>
                                            <option value="menu_book" {{ old('icon', $instruction->icon) == 'menu_book' ? 'selected' : '' }}>📖 Book (قراءة ومناهج تعليمية)</option>
                                            <option value="psychology" {{ old('icon', $instruction->icon) == 'psychology' ? 'selected' : '' }}>🧠 Brain (تنمية الذكاء والقدرات)</option>
                                            <option value="celebration" {{ old('icon', $instruction->icon) == 'celebration' ? 'selected' : '' }}>🎉 Celebration (مكافآت واحتفال)</option>
                                            <option value="toys" {{ old('icon', $instruction->icon) == 'toys' ? 'selected' : '' }}>🧸 Toys (ألعاب وأنشطة أطفال)</option>
                                            <option value="lightbulb" {{ old('icon', $instruction->icon) == 'lightbulb' ? 'selected' : '' }}>💡 Lightbulb (أفكار ومعلومات عامة)</option>
