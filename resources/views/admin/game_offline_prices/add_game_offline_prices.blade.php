...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">اضافة قيمة لعبة جديد</div>
    </div>
    <!--end breadcrumb-->
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('add.game.offline.price.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="coins_number" id="coins_number" class="form-control" value="{{ old('coins_number') }}" />
                                        @error('coins_number')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <script type="text/javascript">
                        ...
                        function updateGradientPreview() {
                            ...
                            const priceVal = document.getElementById('coins_number').value;
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            document.getElementById('coins_number').addEventListener('input', updateGradientPreview);
                        });
                    </script>
