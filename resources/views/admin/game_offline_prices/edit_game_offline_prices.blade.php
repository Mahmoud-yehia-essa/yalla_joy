                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('edit.game.offline.price.store') }}" enctype="multipart/form-data">
                                @csrf
		<input type="hidden" name="id" value="{{ $price->id }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="title" id="title" class="form-control" value="{{ old('title',$price->title) }}" />
                                        @error('title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" step="0.0001" name="coins_number" id="price" class="form-control" value="{{ old('coins_number',$price->coins_number) }}" />
                                        @error('coins_number')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                         ...
                                         <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">عدد الألعاب المضافة</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number"  name="games_number" id="points_number_offline" class="form-control" value="{{ old('games_number',$price->games_number) }}" />
                                        @error('games_number')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="color" name="color1" id="color1" class="form-control form-control-color" value="{{ old('color1', $price->color1) }}" />
                                        @error('color1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="color" name="color2" id="color2" class="form-control form-control-color" value="{{ old('color2', $price->color2) }}" />
                                        @error('color2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="تعديل السعر " />
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <script type="text/javascript">
                        ...
                        function updateGradientPreview() {
                            ...
                            const price = priceVal ? `${priceVal} عدد عملات` : '0 عدد عملات';
