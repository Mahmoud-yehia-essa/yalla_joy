                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="number" class="form-control @error('order_by') is-invalid @enderror"
                               name="order_by" value="{{ old('order_by', $getSponsorHome->order_by) }}" placeholder="أدخل رقم الترتيب (مثال: 1, 2, 3...)" min="1">
                        @error('order_by')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                 ...
                 <!-- Category Photo -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ ($getSponsorHome->photo && file_exists(public_path($getSponsorHome->photo))) ? url($getSponsorHome->photo) : url('upload/no_image.jpg') }}" alt="Preview" style="width:100px; height: 100px;">
                                    </div>
                                </div>
