    ...
    <div class="container">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('edit.price.store') }}" enctype="multipart/form-data">
                                @csrf
		<input type="hidden" name="id" value="{{ $price->id }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" step="0.0001" name="price" id="price" class="form-control" value="{{ old('price',$price->price) }}" />
                                        @error('price')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
