                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('add.price.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" step="0.0001" name="points_number_offline" id="points_number_offline" class="form-control" value="{{ old('points_number_offline') }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" step="0.0001" name="points_number_online" id="points_number_online" class="form-control" value="{{ old('points_number_online') }}" />
