...
<div class="container">
    <div class="main-body">
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('get.question.store.ai') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="info" type="text" class="form-control" value="{{ old('info') }}" />
                                    @error('info') <span class="text-danger">{{ $message }}</span> @enderror
                                                                        <small>اختيارية لتحديد امور محدد في عرض الاسئلة</small>
                             ...
                             <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0"> عدد الأسئلة</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <input name="qu_number" type="number" min="1" max="50" class="form-control" value="{{ old('qu_number') }}"  />

                                    @error('qu_number') <span class="text-danger">{{ $message }}</span> @enderror
                                                                        <small>عدد الأسئلة يؤثر على سرعة عملية البحث</small>
        ...
        <!-- Answer Section -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="submit" class="btn btn-primary px-4" value="إنشاء الأسئلة" />
                            </div>
                        </div>
